...
const Register = () => {
  ...
  const { user, appError, serverError, loading } = store;
              ...
              <div className="px-6 lg:px-20 py-12 lg:py-24 bg-gray-600 rounded-lg">
                <form onSubmit={formik.handleSubmit}>
                  <div className="flex flex-col mb-10">
                    <h3 className="mb-4 text-2xl text-white font-bold font-heading">
                      Register Account
                    </h3>
                    {appError || serverError ? (
                      <div>
                        <span className="text-red-500">{`${serverError}: ${appError}`}</span>
                      </div>
                    ) : null}
                  </div>
                  ...
                  {loading ? (
                    <button
                      disabled
                      className="py-4 w-full bg-[#AED2FF]  text-white font-bold rounded-xl transition duration-200"
                    >
                      Registering...
                    </button>
                  ) : (
                    <button
                      type="submit"
                      className="py-4 w-full bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-xl transition duration-200"
                    >
                      Register
                    </button>
                  )}
